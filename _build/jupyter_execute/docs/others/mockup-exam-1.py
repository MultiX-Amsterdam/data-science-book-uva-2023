...
# **Q2:** If data frame A and B both have no missing data, which of the following operations will likely produce missing data?
# \
# Operation A: Left join
# \
# Operation B: Right join
# \
# Operation C: Inner join
# \
# Operation D: Outer join
# 1. Only operation C
# 2. Only operation D
# 3. Operation C and D
# 4. Operation A, B, and D

# **Q3:** Which of the following statements about overfitting is **FALSE**?
...
# **Q4:** Which of the following statements about the Decision Tree model is **TRUE**?
